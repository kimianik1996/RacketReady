...
public class UserRegistration3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView img = findViewById(R.id.imgRegProfPic);
        ...
        btnCreateUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bitmap imgChosen = img.getDrawingCache();
                ...
                if (flags.isEmpty()){
                    ...
                    while(c.moveToNext()){
                        isInserted = db.addMembership(c.getInt(0),"Standard","None",0);
                    }
                    if (isInserted){
                        Toast.makeText(UserRegistration3.this, "Current Membership: Standard", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(UserRegistration3.this, Login.class));
                    }
                    else{
                        Toast.makeText(UserRegistration3.this, "Error with Membership Authentication", Toast.LENGTH_LONG).show();
                    }
                }else{
